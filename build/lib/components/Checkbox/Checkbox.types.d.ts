 ...
 */
export declare type CheckboxColors = 'primary' | 'secondary';
declare type AccessibilityCheckboxProps = Pick<AccessibilityProps, 'accessibilityLabel' | 'accessibilityHint' | 'accessibilityRole' | 'accessibilityState'>;
