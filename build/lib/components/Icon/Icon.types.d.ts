 ...
 */
declare type IconsColorsDeprecated = 'default' | '#333333';
export declare type IconColors = keyof Color | IconsColorsDeprecated;
export declare type IconSizes = keyof Size;
