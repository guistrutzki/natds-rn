...
export declare type ButtonSizes = 'semi' | 'semiX' | 'medium' | ButtonSizesDeprecated;
export declare type ButtonTypes = 'contained' | 'outlined' | 'text';
...
declare type AccessibilityButtonProps = Pick<AccessibilityProps, 'accessibilityActions' | 'onAccessibilityAction' | 'accessibilityHint' | 'accessibilityLabel'>;
