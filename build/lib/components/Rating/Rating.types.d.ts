...
export declare type RatingValueProps = 0 | 1 | 2 | 3 | 4 | 5;
export declare type RatingVarianstProps = 'read-only' | 'input' | 'counter';
export declare type RatingAlignProps = 'left' | 'right';
...
export declare type RatingInputProps = RatingBaseProps & {
     ...
     */
    onPress: (e: RatingValueProps | number) => void;
    /** Sets the amount of filled stars, range: 0 to 5
     */
    rate?: RatingValueProps | number;
};
