...
export declare type Variants = 'standard' | 'outlined' | 'filled';
export declare type Types = 'success' | 'error' | 'warning' | 'info' | 'custom';
...
export declare type AlertCustomProps = AlertBaseProps & {
    /**
     * Color types will define the template with colors and iconography.
     */
    type: 'custom';
...
export declare type AlertProps = AlertBaseProps | AlertCustomProps;
