...
import { Container, Layer, Line, View } from './ProgressIndicator.styles';
export const ProgressIndicatorComponent = ({ size = 'medium', showLayer = false, brand }) => {
    /**
    ...
    return (<View size={size} showLayer={showLayer}>
