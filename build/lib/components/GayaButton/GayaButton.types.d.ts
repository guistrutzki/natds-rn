 ...
 */
declare type ButtonSizesDeprecated = 'small' | 'large';
export declare type GayaButtonSizes = 'semi' | 'semiX' | 'medium' | ButtonSizesDeprecated;
export declare type GayaButtonTypes = 'contained' | 'outlined' | 'ghost' | 'tonal';
export declare type GayaButtonColor = 'primary' | 'onPrimary' | 'secondary' | 'onSecondary' | 'neutral' | 'inverse';
export declare type IconPositions = 'left' | 'right';
export declare type ITextTransformProp = 'uppercase' | 'lowercase' | 'capitalize';
export interface GayaButtonBaseProps extends GayaButtonProps {
    theme: Theme;
    textLabelStyle?: StyleProp<TextStyle>;
}
declare type AccessibilityButtonProps = Pick<AccessibilityProps, 'accessibilityActions' | 'onAccessibilityAction' | 'accessibilityState' | 'accessibilityHint' | 'accessibilityLabel'>;
